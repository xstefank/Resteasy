...
public class CdiResourceBuilder extends JaxrsResourceBuilder
{
   ...
   public CdiResourceBuilder()
   {
      ...
      {
         // the lookup may fail when there is no CDI provider on the classpath
         // in that case delagate back to JaxrsResourceBuilder to keep backward compatibility
