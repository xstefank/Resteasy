...
@RunAsClient
public class ClientResponseFilterRegistrationTest extends ClientTestBase {

   static Client client;

   @Deployment
   public static Archive<?> deploy() {
      WebArchive war = ShrinkWrap.create(WebArchive.class, ClientResponseFilterRegistrationTest.class.getSimpleName() + ".war");
   ...
   public void filterRegisteredTest() throws Exception {
      WebTarget base = client.target(generateURL("/") + "testIt").register(ClientDummyMessageBodyReader.class);
