...
public class PathStereotypeTest
{
   ...
   protected static final Logger logger = LogManager.getLogger(PathStereotypeTest.class.getName());
   ...
   {
      WebArchive war = TestUtil.prepareArchive(PathStereotypeTest.class.getSimpleName());
   ...
   {
      return PortProviderUtil.generateURL(path, PathStereotypeTest.class.getSimpleName());
   }
}
